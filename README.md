[![version](https://img.shields.io/badge/version-2.0.2-green.svg)](https://github.com/steevanb/php-code-sniffs/tree/2.0.2)
[![php](https://img.shields.io/badge/php-^7.1-blue.svg)](https://php.net)
![Lines](https://img.shields.io/badge/code%20lines-1891-green.svg)
...
```bash
composer require steevanb/php-code-sniffs ^2.0.2
```
